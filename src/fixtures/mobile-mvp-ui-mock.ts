...
export function getMockProperties(actor: SelectedActor | null): PropertyRecord[] {
  ...
  return propertySeeds.map((seed, index) => ({
    ...
    rating_location: index % 3 === 0 ? 5 : index % 3 === 1 ? 4 : 3,
    rating_price: index % 2 === 0 ? 4 : 3,
    rating_condition: index % 4 === 0 ? 5 : 4,
    rating_sunlight: null,
    rating_environment: null,
    pros: null,
    cons: null,
    memo: index === 0 ? "주차장과 동선 확인 완료." : index === 2 ? "학교 도보 10분, 마트 바로 앞." : null,
